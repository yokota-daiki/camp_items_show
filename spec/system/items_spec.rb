...
RSpec.describe "Items", type: :system do
  ...
  let!(:myitem_tent) { create(:myitem, user: user, item: tent_item) }
  let!(:myitem_bed) { create(:myitem, user: user, item: bedding_item) }
  let!(:myitem_light) { create(:myitem, user: user, item: light_item) }
  before { login(user) }
